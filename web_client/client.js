...
function load_page(mdFileName){
    ...
    try{
        var md = fs.readFileSync(__dirname + "/frontend/" + mdFileName,'utf8');
...
app.get('/', function(req,res){
    if(server_ip != undefined && server_ip.length > 0){
        ...
        res.sendFile(__dirname + "/frontend/" + "get_server.html");
});
...
app.get('/user/add',function(req,res){
    res.sendFile(__dirname + "/frontend/" + "user_add.html");
});

app.get('/user/edit', function (req, res) {
    res.sendFile(__dirname + "/frontend/" + "user_edit.html");
});
...
app.get('/module/edit', function (req, res) {
    res.sendFile(__dirname + "/frontend/" + "module_edit.html");
});
...
app.get('/module/add', function (req, res) {
    res.sendFile(__dirname + "/frontend/" + "module_add.html");
});
